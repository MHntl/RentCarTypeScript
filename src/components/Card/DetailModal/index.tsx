      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-25 z-20 grid place-items-center p-4">
          ...
          >
             ...
             * key-value'lar dan oluşan dizi döndürür
             */}
            {Object.entries(car) // objeyi diziye çevir
              .filter((item) => item[0] !== "year") //key değeri year denk gelen item diziden çıkart
              .map(([key, value]) => (
                <div className="flex justify-between">
                  {/*CSS | text-transform:capitalize  = her kelimenin ilk harfini büyütür*/}
